...
const FIELD_DEFS = {
  ...
  tab_control: [
    ...
    // Columnas para Controles de Brutos (Controlar y Generar Reporte):
    { key: 'tabSalBaseColumn',      label: 'SUELDO — columna en Tabulado (Brutos)',      required: false },
    { key: 'tabACuFutAumenColumn',  label: 'A_CTA_FUT_AUMEN — col. en Tabulado (Brutos)', required: false },
    { key: 'tabFecIniColumn',       label: 'Fecha Inicio — columna en Tabulado (Brutos)', required: false },
    { key: 'tabFecFinColumn',       label: 'Fecha Fin — columna en Tabulado (Brutos)',   required: false },
    { key: 'tabFecAltaColumn',      label: 'Fecha Alta — columna en Tabulado (Brutos)',  required: false },
    { key: 'tabFecBajaColumn',      label: 'Fecha Baja — columna en Tabulado (Brutos)',  required: false },
    { key: 'tabFecPagoColumn',      label: 'Fecha de Pago — columna en Tabulado (Brutos)', required: false },
    { key: 'tabIdEquipoColumn',     label: 'ID Equipo — columna en Tabulado (Brutos)',   required: false },
  ],
  cat_empleados: [
